  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return db.query('SELECT tabla_usuario.id_usuario, tabla_usuario.id_acceso, tabla_accesos.tipo_acceso, tabla_usuario.id_area, tabla_areas.nombre_area, tabla_usuario.nombre_usuario, tabla_usuario.numero_empleado, tabla_usuario.correo, tabla_usuario.telefono, tabla_usuario.usuario, tabla_usuario.usuario_alta, tabla_usuario.fecha_alta, tabla_usuario.activo FROM tabla_usuario INNER JOIN tabla_accesos ON tabla_usuario.id_acceso = tabla_accesos.id_acceso INNER JOIN tabla_areas ON tabla_usuario.id_area = tabla_areas.id_area WHERE activo != 0 ORDER BY id_usuario DESC;', function (err, rows, fields) {
            if (!err) {
